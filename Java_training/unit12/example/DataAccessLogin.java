...
public class DataAccessLogin {
    ...
    private final static Logger logger = Logger.getLogger(DataAccessLogin.class.getName());
    Connection connection = null;
    CachedRowSet rowSet;

    public DataAccessLogin() throws ClassNotFoundException, SQLException {
        ...
        rowSet.setCommand("select * from hiennv_javabasic");
    ...
    public int numberOfPage() throws SQLException {
        ...
        try {
            ...
            ResultSet rs = statement.executeQuery("select count(*) from hiennv_javabasic");
            if (!rs.next()) {
                return 0;
            }
    ...
    public static void main(String[] args) throws SQLException, ClassNotFoundException {
        DataAccessLogin data = new DataAccessLogin();
